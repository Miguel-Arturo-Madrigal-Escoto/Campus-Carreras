...
<html lang="es">
	...
	<body>
		...
		<div class="hero-area section">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(img/teacher.jpg);"></div>
			<!-- /Backgound Image -->
					...
					<div class="col-md-6">
						<div class="contact-form">
							...
							<form action="admin/inicio.php" method="post">
								<input class="input" type="text" name="usuario" placeholder="Codigo de administrador" required>
								<input class="input" type="password" name="contrasena" placeholder="Contraseña" required>
								<input type="submit" value="Iniciar sesion" class="main-button icon-button pull-right" name="iniciarAdmin"/>
                                <br>
                                <br><br>
							</form>
						</div>
