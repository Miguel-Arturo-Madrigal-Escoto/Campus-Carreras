...
$datosAlumnoQuery = "SELECT * FROM alumnos WHERE generacion='$generacion' AND egresado='1'";
...
$nombreEmp = utf8_decode(mb_strtoupper($nombre['nombre']));
  ...
  $pdf->Cell(88.3,5,$datos['numeroEmergencia'],"LTB",0,"C");
  $pdf->Cell(43.8,5,$datos['padreEmergencia'],"TB",0,"C");
