...
<body>
    ...
    <br>
        ...
        <b>Nombre: </b><input type="text" name="nombre" value="<?php echo $empresa['nombre']; ?>" required /><br /><br />
        <b>Contraseña: </b><input type="text" name="contrasena" value="<?php echo $empresa['contrasena']; ?>" required /><br /><br />
        <b>Calle: </b><input type="text" name="calle" value="<?php echo $empresa['calle']; ?>" required /><br /><br />
        <b>Numero exterior: </b><input type="text" name="numExt" value="<?php echo $empresa['numExt']; ?>" required /><br /><br />
        <b>Colonia: </b><input type="text" name="colonia" value="<?php echo $empresa['colonia']; ?>" required /><br /><br />
        <b>Codigo Postal: </b><input type="text" name="cp" value="<?php echo $empresa['cp']; ?>" required /><br /><br />
        <b>Municipio: </b><input type="text" name="municipio" value="<?php echo $empresa['municipio']; ?>" required /><br /><br />
        <b>Estado: </b><input type="text" name="estado" value="<?php echo $empresa['estado']; ?>" required /><br /><br />
        <b>Encargado: </b><input type="text" name="encargado" value="<?php echo $empresa['encargado']; ?>" required /><br /><br />
        <b>Cargo del encargado: </b><input type="text" name="cargoDir" value="<?php echo $empresa['cargoDir']; ?>" required /><br /><br />
        <b>Departamento: </b><input type="text" name="departamento" value="<?php echo $empresa['departamento']; ?>" /><br /><br />
        <b>Actividades: </b><input type="text" name="actividades" value="<?php echo $empresa['actividades']; ?>" required /><br /><br />
        <b>Telefono: </b><input type="text" name="telefono" required value="<?php echo $empresa['telefono']; ?>" required /><br /><br />
        <b>Correo: </b><input type="email" name="correo" value="<?php echo $empresa['correo']; ?>" required /><br /><br />
        <b>Sitio Web: </b><input type="text" name="sitioWeb" value="<?php echo $empresa['sitioWeb']; ?>"/><br /><br /><br />
        </div><br><br><hr>
