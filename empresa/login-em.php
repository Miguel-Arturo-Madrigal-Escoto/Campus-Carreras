...
<head>
	...
	<body>
		...
		<div class="hero-area section">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(img/enterprise.jpeg);"></div>
			<!-- /Backgound Image -->
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="contact-form">
							<h4>Empresa</h4>
							<form action="empresa/inicio.php" method="post">
								<input class="input" type="text" name="usuario" placeholder="Codigo de empresa" required>
								<input class="input" type="password" name="contrasena" placeholder="Contraseña" required>
								<input type="submit" value="Iniciar sesion" class="main-button icon-button pull-right" name="iniciarEmpresa"/>
                                <br>
                                <br><br>
							</form>
						</div>
